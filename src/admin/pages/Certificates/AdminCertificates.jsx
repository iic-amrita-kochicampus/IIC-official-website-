...
export default function AdminCertificates() {
  const {
    ...
    loading,
    refetch,
  } = useSupabase(TABLES.CERTIFICATES, {
    orderBy: 'year',
    ascending: false,
  })
  ...
  const onSubmit = async (data) => {
    ...
    if (thumbnailFile) {
      ...
      payload.thumbnail_url = payload.document_url
    }
        ...
        <div className="admin-card overflow-x-auto">
          <table className="w-full text-left min-w-[600px]">
            <thead className="bg-admin-surface-2">
              <tr>
                <th className="px-6 py-4 text-sm font-semibold text-admin-muted">
                  Title
                </th>
            ...
            <tbody className="divide-y divide-admin-border">
              {certs.map((c) => (
                <tr
                  key={c.id}
                  className="hover:bg-admin-surface-2"
                >
                  ...
                  <td className="px-6 py-4 flex gap-2">
                    <button
                      onClick={() => openEdit(c)}
                      className="p-2 hover:bg-admin-surface-2 rounded-lg"
                    >
                      <Edit2
                        size={16}
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              >
                ...
                <option value="Establishment Order">
                  Establishment Order
                </option>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 admin-input file:mr-4 file:py-1 file:px-4 file:rounded-lg file:border-0 file:bg-primary/10 file:text-primary file:font-medium"
            />
          </div>
