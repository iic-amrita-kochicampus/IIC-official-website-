      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-10 py-16 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <a href="https://www.instagram.com/iic.asas?igsh=dHZ4aWNqcHk4dXds" target="_blank" rel="noopener noreferrer" aria-label="Instagram" data-cursor-hover className="w-9 h-9 rounded-full glass-card flex items-center justify-center text-fog hover:text-innovation-orange">
            ...
            <a href="https://www.linkedin.com/company/institutions-innovation-council-asas/posts/?feedView=all" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" data-cursor-hover className="w-9 h-9 rounded-full glass-card flex items-center justify-center text-fog hover:text-innovation-orange">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
